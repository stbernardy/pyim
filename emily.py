import sys #imports sys, sys.exit() used to kill the game
import time #used to time the responses, time.sleep()
...
if response3 == "1":
	print("{0} you dirty, dirty boy, I like you {1}.").format(e, user_name)
	print ("1. So should I come over and shmang?\n 2. I actually just showered\n 3. what's your sister doing?")
	response31 = raw_input ("> ")

	if response31 == "1":
		print ("{0} Yes please, I'm going to get ready ;) bring condoms... I'm going to get off, see you in a bit!!").format(e)
		print ("{0}").format(leftChat)
		print end
		sys.exit()
